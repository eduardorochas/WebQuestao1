    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CandidatoId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nome = table.Column<string>(maxLength: 200, nullable: true),
                    CPF = table.Column<int>(maxLength: 200, nullable: false),
                    ...
                    CargoID = table.Column<int>(nullable: false),
                    SalarioProposto = table.Column<decimal>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Candidato", x => x.CandidatoId);
                    table.ForeignKey(
                        name: "FK_Candidato_Cargo_CargoID",
                        column: x => x.CargoID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LinguaEstrangeira", x => x.LinguaEstrangeiraID);
                    table.ForeignKey(
