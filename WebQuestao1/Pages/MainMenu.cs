...
namespace WebQuestao1.Pages
{
    public static class MainMenu
    {
        ...
        {
            public const string PageName = "Produto";
        ...
        {
            public const string PageName = "Bloco";
            public const string RoleName = "Block";
            public const string Path = "/Block/Index";
            public const string ControllerName = "Block";
            public const string ActionName = "Index";
        }

        public static class BlockCultivation
        {
            public const string PageName = "BlockCultivation";
            public const string RoleName = "BlockCultivation";
            public const string Path = "/BlockCultivation/Index";
            public const string ControllerName = "BlockCultivation";
            public const string ActionName = "Index";
        }
        ...
        {
            public const string PageName = "Cultivos";
            public const string RoleName = "Cultivation";
            public const string Path = "/Cultivation/Index";
            public const string ControllerName = "Cultivation";
            public const string ActionName = "Index";
        }
        public static class Currency
        {
            public const string PageName = "Moeda";
        ...
        {
            public const string PageName = "Fazenda";
            public const string RoleName = "Farm";
            public const string Path = "/Farm/Index";
            public const string ControllerName = "Farm";
            public const string ActionName = "Index";
        }
        ...
        {
            public const string PageName = "Tipo de Produtos";
        ...
        {
            public const string PageName = "Unidade de Medidas";
        ...
        {
            public const string PageName = "Almoxarifado";
